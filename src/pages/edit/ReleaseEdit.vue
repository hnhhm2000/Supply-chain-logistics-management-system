                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item label="财务:">
                      <el-input
                        v-model="releaseInfo.accounting"
                        size="small"
                        class="input"
                        disabled
                      ></el-input>
                  ...
                  <el-col :span="8">
                    <el-form-item label="编号:">
                      <el-input
                        v-model="releaseInfo.releaseNumber"
                        size="small"
                        class="input"
                      ></el-input>
                    </el-form-item>
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item label="出库时间:">
                      <el-date-picker
                        v-model="releaseInfo.dateTimeOut"
                        type="date"
                        placeholder="选择日期"
                        size="small"
                        class="input"
                ...
                <el-row>
                  ...
                  <el-col :span="8">
                    <el-form-item label="创建时间:">
                      <el-date-picker
                        v-model="releaseInfo.createTime"
                        type="datetime"
                        placeholder="选择日期"
                        size="small"
                        class="input"
                ...
                <el-row>
                  <el-col :span="8">
                    <el-form-item label="更新时间:">
                      <el-date-picker
                        v-model="releaseInfo.updateTime"
                        type="datetime"
                        placeholder="选择日期"
                        size="small"
                        class="input"
    ...
    <footer class="btns">
      <div style="margin-top: 2em">
        ...
        <el-button
          type="primary"
          plain
          @click="$router.push({ path: '/release' })"
          >返回</el-button
        >
      </div>
    </footer>
...
<script>
import { updateReleaseData, getReleaseDetail } from "@/api/Release";
